...
def main(input_experiment_name,input_variants_csv,input_coverage_csv,input_basecalls_csv,input_outgroup_csv,length,reference,save_tmp,run_pipeline):
...
if __name__ == '__main__':
    main(args.name,args.input_variants_csv,args.input_coverage_csv,args.basecalls_csv,args.outgroup_csv,args.length,args.reference,args.save_tmp,args.run_pipeline)
