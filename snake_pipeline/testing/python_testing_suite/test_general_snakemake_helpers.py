...
class TestMyFunction(unittest.TestCase):
    ...
    def test_genomestats(self):
        ...
        self.assertEqual(gus.genomestats(test_genome_dir_full)[2][0],np.array(scafnames_correct)[0])
        self.assertEqual(gus.genomestats(test_genome_dir_full)[2][1],np.array(scafnames_correct)[1])
